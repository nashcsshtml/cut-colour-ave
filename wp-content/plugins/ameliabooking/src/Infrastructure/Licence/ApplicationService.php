 ...
 */
class ApplicationService extends Pro\ApplicationService
{
    /**
    ...
    private static $licenseClassMap = [
        ...
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Pro\ApplicationService',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        if (!AMELIA_DEV) {
            return 'AmeliaBooking\Infrastructure\Licence\Pro\ApplicationService';
        }
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Pro\ApplicationService';
    }
