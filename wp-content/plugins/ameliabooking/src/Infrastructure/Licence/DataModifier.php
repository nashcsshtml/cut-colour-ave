 ...
 */
class DataModifier extends Pro\DataModifier
{
    /**
    ...
    private static $licenseClassMap = [
        ...
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Pro\DataModifier',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        if (!AMELIA_DEV) {
            return 'AmeliaBooking\Infrastructure\Licence\Pro\DataModifier';
        }
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Pro\DataModifier';
    }
