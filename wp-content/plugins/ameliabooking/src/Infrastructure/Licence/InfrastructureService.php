 ...
 */
class InfrastructureService extends Pro\InfrastructureService
{
    /**
    ...
    private static $licenseClassMap = [
        ...
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Pro\InfrastructureService',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        if (!AMELIA_DEV) {
            return 'AmeliaBooking\Infrastructure\Licence\Pro\InfrastructureService';
        }
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Pro\InfrastructureService';
    }
